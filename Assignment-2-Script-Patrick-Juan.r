...
#***Skipping over the rest of the partial plots for sake of rapid model development
...
#Okay we're gonna ignore the other transformations and just stick with Logging it and testing AIC
...
#AIC got worse! Wrong transformation! 
#Try Square rooting
...
#***MODIFICATION - WHAT HAPPENS IF I SQUARE ROOT INSTEAD??? That could also help AIC
...
#Seems like no matter what transformation I do, AIC becomes worse
...
#Kinda u-shaped, so try square again
...
#Okay definitely didn't work, so try log
...
#^^^ THIS HAD REALLY GOOD AIC AND REALLY STRONG LIFT CHART RESULTS
#****THEREFORE MAKE ABOVE FINAL MODEL FORREAL (none of the nonsense before)
...
#AIC was better than logging DA, but the lift chart was kinda worse, so stick with Logis7.0
